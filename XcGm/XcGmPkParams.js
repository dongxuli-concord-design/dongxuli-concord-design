...
class XcGmPK_UVBox_t {
  ...
  static fromXcGmUVBox({uvBox}) {
    const pkUVBox = new XcGmPK_UVBox_t({
      param: [
        uvBox.lowU,
        uvBox.lowV,
        uvBox.highU,
  ...
  static fromJSON({json}) {
    const pkUVBox = new XcGmPK_UVBox_t({param: json.param});
    return pkUVBox;
  }
...
class XcGmPK_UV_t {
  ...
  static fromJSON({json}) {
    const pkUV = new XcGmPK_UV_t({param: json.param});
    return pkUV;
  }
...
class XcGmPK_BOX_t {
  ...
  static fromJSON({json}) {
    const pkBox = new XcGmPK_BOX_t({coord: json.coord});
    return pkBox;
  }
...
class XcGmPK_INTERVAL_t {
  ...
  static fromXcGmInterval({interval}) {
    const pkInterval = new XcGmPK_INTERVAL_t({value: [interval.low, interval.high]});
    return pkInterval;
  }

  static fromJSON({json}) {
    const pkInterval = new XcGmPK_INTERVAL_t({value: json.value});
    return pkInterval;
  }
...
class XcGmPK_VECTOR_t {
  ...
  static fromJSON({json}) {
    const pkVector = new XcGmPK_VECTOR_t({coord: json.coord});
    return pkVector;
  }
...
class XcGmPK_AXIS1_sf_t {
  ...
  constructor({
                location = new XcGmPK_VECTOR_t({coord: [0, 0, 0]}),
                axis = new XcGmPK_VECTOR_t({coord: [0, 0, 1]}),
              } = {}) {
  ...
  static fromXcGm3dAxis({axis}) {
    const axis1 = new XcGmPK_AXIS1_sf_t({
      location: new XcGmPK_VECTOR_t({coord: [axis.position.x, axis.position.y, axis.position.z]}),
      axis: new XcGmPK_VECTOR_t({coord: [axis.direction.x, axis.direction.y, axis.direction.z]})
    });
    return axis1;
  }

  static fromJSON({json}) {
    const location = XcGmPK_VECTOR_t.fromJSON({json: json.location});
    const axis = XcGmPK_VECTOR_t.fromJSON({json: json.axis});
    const axis1 = new XcGmPK_AXIS1_sf_t({location, axis});
    return axis1;
  }
...
class XcGmPK_AXIS2_sf_t {
  ...
  static fromXcGmCoordinateSystem({coordinateSystem}) {
    const location = new XcGmPK_VECTOR_t({coord: [coordinateSystem.origin.x, coordinateSystem.origin.y, coordinateSystem.origin.z]});
    const axis = new XcGmPK_VECTOR_t({coord: [coordinateSystem.zAxisDirection.x, coordinateSystem.zAxisDirection.y, coordinateSystem.zAxisDirection.z]});
    const ref_direction = new XcGmPK_VECTOR_t({coord: [coordinateSystem.xAxisDirection.x, coordinateSystem.xAxisDirection.y, coordinateSystem.xAxisDirection.z]});
    const axis2 = new XcGmPK_AXIS2_sf_t({location, axis, ref_direction});
    return axis2;
  }
  ...
  static fromJSON({json}) {
    const location = XcGmPK_VECTOR_t.fromJSON({json: json.location});
    const axis = XcGmPK_VECTOR_t.fromJSON({json: json.axis});
    const ref_direction = XcGmPK_VECTOR_t.fromJSON({json: json.ref_direction});
    const axis2 = new XcGmPK_AXIS2_sf_t({location, axis, ref_direction});
    return axis2;
  }
...
class XcGmPK_TRANSF_sf_t {
  ...
  static fromXcGm3dMatrix({matrix}) {
    const transfSF = new XcGmPK_TRANSF_sf_t({matrix: [...matrix.entry]});
    return transfSF;
  }

  static fromJSON({json}) {
    const transfSF = new XcGmPK_TRANSF_sf_t({matrix: JSON.parse(json.matrix)});
    return transfSF;
  }
...
class XcGmPK_CIRCLE_sf_t {
  ...
  constructor({
                radius,
                basis_set = new XcGmPK_AXIS2_sf_t()
              }) {
    this.radius = radius;
  ...
  static fromJSON({json}) {
    ...
    const basis_set = XcGmPK_AXIS2_sf_t.fromJSON({json: json.basis_set})
    const circleSF = new XcGmPK_CIRCLE_sf_t({radius, basis_set});
    return circleSF;
  }
...
class XcGmPK_LINE_sf_t {
  ...
  constructor({basis_set = new XcGmPK_AXIS1_sf_t()} = {}) {
    this.basis_set = basis_set;
  }

  static fromXcGm3dAxis({axis}) {
    const basis_set = XcGmPK_AXIS1_sf_t.fromXcGm3dAxis({axis});
    const lineSF = new XcGmPK_LINE_sf_t({basis_set});
    return lineSF;
  }

  static fromJSON({json}) {
    const basis_set = XcGmPK_AXIS1_sf_t.fromJSON({json: json.basis_set});
    const lineSF = new XcGmPK_LINE_sf_t({basis_set});
    return lineSF;
  }
...
class XcGmPK_POINT_sf_t {
  ...
  constructor({position = new XcGmPK_VECTOR_t()}) {
  ...
  static fromJSON({json}) {
    const position = XcGmPK_VECTOR_t.fromJSON({json: json.position});
    const pointSF = new XcGmPK_POINT_sf_t({position});
    return pointSF;
  }
...
class XcGmPK_BCURVE_sf_t {
  ...
  static fromJSON({json}) {
    const bCurveSF = new XcGmPK_BCURVE_sf_t({
      degree: json.degree,
...
class XcGmPK_INSTANCE_sf_t {
  ...
  static fromJSON({json}) {
    const instanceSF = new XcGmPK_INSTANCE_sf_t();
    instanceSF.assembly = XcGmEntity.getObjFromTag({entityTag: json.assembly});
    instanceSF.transf = json.transf ? XcGmEntity.getObjFromTag({entityTag: json.transf}) : null;
    instanceSF.part = XcGmEntity.getObjFromTag({entityTag: json.part});
...
class XcGmPK_PLANE_sf_t {
  ...
  constructor({basis_set = new XcGmPK_AXIS2_sf_t()}) {
    this.basis_set = basis_set;
  }

  static fromXcGmCoordinateSystem({coordinateSystem}) {
    const basis_set = XcGmPK_AXIS2_sf_t.fromXcGmCoordinateSystem({coordinateSystem});
    const planeSF = new XcGmPK_PLANE_sf_t({basis_set});
    return planeSF;
  }
...
class XcGmPK_SPHERE_sf_t {
  ...
  static fromJSON({json}) {
    ...
    sphereSF.basis_set = XcGmPK_AXIS2_sf_t.fromJSON({json: json.basis_set})
  }
...
class PK_BODY_extrude_o_t {
  ...
  constructor({
                start_bound = new PK_bound_def_s({
                  bound: XcGmPkTokens.PK_bound_distance_c,
                  forward: true,
                  distance: 0.0,
                  entity: 0,
                  nearest: true,
                  nth_division: 1,
                  side: XcGmPkTokens.PK_bound_side_both_c
                }),
                end_bound = new PK_bound_def_s({
                  bound: XcGmPkTokens.PK_bound_distance_c,
                  forward: true,
                  distance: 1.0,
                  entity: 0,
                ...
                consistent_params = XcGmPkTokens.PK_PARAM_consistent_unset_c,
              } = {}) {
  ...
  static fromJSON({json}) {
    const extrudeOption = new PK_BODY_extrude_o_t({
      start_bound: PK_bound_def_s.fromJSON(json.start_bound),
      end_bound: PK_bound_def_s.fromJSON(json.end_bound),
...
class PK_bound_def_s {
  ...
  static fromJSON({json}) {
    const boundDef = new PK_bound_def_s({
      bound: json.bound,
